...
export default function ClientesLista1({ api }) {
    ...
    function mostrarMensagem(
        ...
        if (topoModalRef.current) {
            topoModalRef.current.scrollIntoView({
                behavior: 'smooth',
                block: 'start'
            });
        }
    ...
    async function handleSalvarEdicao() {
        ...
        if (tipo === 'juridico') {
            ...
            if (repPreenchido) {
                ...
                if (
                    ...
                    mostrarMensagem(
                        'CPF do representante é inválido.',
                        'erro'
                    );
                ...
                if (
                    !String(
                        dadosRepresentante.sexo ||
                        ''
                    ).trim()
                ) {
                    mostrarMensagem(
                        'Sexo do representante é obrigatório.',
                        'erro'
                    );
        ...
        try {
            const payload = {
                ...
                orgao_expedidor:
                dadosEditados.orgao_expedidor,

                carteira_trabalho:
                dadosEditados.carteira_trabalho,

                serie_carteira:
                dadosEditados.serie_carteira,

                profissao:
                dadosEditados.profissao,

                estado_civil:
                dadosEditados.estado_civil,

                nacionalidade:
                dadosEditados.nacionalidade,
                ...
                representante:
                    ...
                    Object.keys(
                        ...
                        ? {
                            ...
                            rg:
                            dadosRepresentante.rg,

                            orgao_expedidor:
                            dadosRepresentante.orgao_expedidor,

                            nacionalidade:
                            dadosRepresentante.nacionalidade,

                            estado_civil:
                            dadosRepresentante.estado_civil
                        }
                        : null
            };

            const response = await fetch(
                `${API_URL}/cliente/${clienteSelecionado.id}`,
                {
                    method: 'PUT',
                    credentials: 'include',
    ...
    async function handleInativar() {
        ...
        try {
            const response = await fetch(
                `${API_URL}/cliente/${clienteInativar.id}/inativar`,
                {
                    method: 'PUT',
                    credentials: 'include',
    ...
    async function handleAtivar(
        ...
        try {
            const response = await fetch(
                `${API_URL}/cliente/${cliente.id}/ativar`,
                {
                    method: 'PUT',
                    credentials: 'include',
                            ...
                            <table className={css.tabela}>
                                ...
                                {clientesFiltrados.map(cliente => (
                                    ...
                                    <tr key={cliente.id}>
                                        ...
                                        <td data-label="Nome">
                                                <span className={css.nomeCliente}>
                                                    {cliente.nome || '--'}
                                                </span>
                                        </td>
                                        ...
                                        >
                                            <div className={css.acoesCliente}>
                                        ...
                                        <>
                                            ...
                                            <div className={css.linha}>
                                                ...
                                                <div className={css.campoMetade}>
                                                    ...
                                                    <div className={css.campoComAviso}>
                                                        <input
                                                            type="text"
                                                            name="cep"
                                                            className={css.input}
                ...
                >
                    <div className={css.modalInativacao}>
                        ...
                        <p className={css.subtituloInativacao}>
                            Confirme para inativar o cliente{' '}

                            <strong>
                                {clienteInativar.nome}
                            </strong>.
                        </p>
